...
{
    //计算建筑物间邻近关系，考虑街道
    //在VoronoiDiagram中添加了计算移位场的函数（根据道路；根据给定建筑物）
    public partial class ProximityBuilder : Form
    {
        public ProximityBuilder(IMap cMap)
        {
            InitializeComponent();
            this.pMap = cMap;
        }
        ...
        private void ProximityBuilder_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //pg.CreateAlphaShape(pg.PgforBuildingNodesList, pg.PgforBuildingEdgesList, 36);
            ...
            //if (OutPath != null) { pg.WriteProxiGraph2Shp(OutPath, "ProxiGraph", pMap.SpatialReference, pg.PgforBuildingNodesList,pg.PgforBuildingEdgesList); }
            //if (OutPath != null) { pg.WriteProxiGraph2Shp(OutPath, "邻近图", pMap.SpatialReference, pg.NodeList, pg.EdgeList); }
            ...
            if (OutPath != null) { ske.Create_WriteSkeleton_Segment2Shp(OutPath, "Skeleton", pMap.SpatialReference); }   
            #endregion
        }
    }
}

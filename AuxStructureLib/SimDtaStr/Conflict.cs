...
namespace AuxStructureLib
{
    ...
    public class Conflict
    {
        ...
        public static void WriteConflict2File(List<Conflict> Conflicts, string filePath, string fileName, SMap map, ProxiGraph pg, ISpatialReference pSpatialReference)
        {
            ...
            pg1.WriteProxiGraph2Shp(filePath, fileName, pSpatialReference,pg1.NodeList,pg1.EdgeList);
        }
    }
}

...
namespace AuxStructureLib
{
    ...
    public class MSTGraph
    {
        ...
        /// </summary>
        /// <param name="?"></param>
        public static void Create_WriteClusters(ProxiGraph pg, ISpatialReference pSpatialReference)
        {
            ...
            {
                i++;
                cPG.WriteProxiGraph2Shp(@"E:\DelaunayShape",@"Cluster"+i.ToString(), pSpatialReference,cPG.NodeList,cPG.EdgeList);
            }
        }
    }
}

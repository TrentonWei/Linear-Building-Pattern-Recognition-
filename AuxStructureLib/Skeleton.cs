...
namespace AuxStructureLib
{
    ...
    public class Skeleton
    {
       ...
       // private ConsDelaunayTin cdt;
        ...
        public void PreProcessCDTforPLP(bool isDAobu)
        {
        ...
        public void Create_WriteSkeleton_Segment2Shp(string filePath, string fileName, ISpatialReference pSpatialReference)
        {

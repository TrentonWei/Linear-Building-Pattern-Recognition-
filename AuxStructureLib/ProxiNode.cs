...
namespace AuxStructureLib
{
    ...
    public class ProxiNode:Node
    {
        ...
        public bool BoundaryNode = false;//标识是否是pattern的边界点
        public bool IntersectNode = false;//标识是否是pattern的相交点
        ...
        public static void Create_WriteProxiNodes2Shp(string filePath, string fileName, List<ProxiNode> nodeList, ISpatialReference pSpatialReference)
        {

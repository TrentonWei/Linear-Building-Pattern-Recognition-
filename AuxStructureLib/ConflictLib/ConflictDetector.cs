...
namespace AuxStructureLib.ConflictLib
{
    ...
    public class ConflictDetector
    {
        ...
        /// 冲突检测
        /// </summary>
        /// PolygonList 对应的建筑物集合
        public bool DetectConflictByPG(List<PolygonObject> PolygonList,AxMapControl pMapControl)
        {           
            ConflictList = new List<ConflictBase>();
                            ...
                            for (int j = 0; j < PolygonList.Count; j++)
                            {
                                if (j != i)
                                {
                                    ...
                                    if (Pn2.TagID == PolygonObject2.ID && Pn2.FeatureType == FeatureType.PolygonType)
                                    {
                                        ...
                                        //IPointCollection pointSet = pPolygon1 as IPointCollection;

                                        //if (PolygonObject1.PointList!=null)
                                        //{
                                        //    int m = PolygonObject1.PointList.Count;

                                        //    for (int k = 0; k < m; k++)
                                        //    {
                                        //        curPoint = PolygonObject1.PointList[k];
                                        ...
                                        //IPoint curResultPoint2 = null;
                                        //TriNode curPoint2 = null;
                                        //IPointCollection pointSet2 = pPolygon2 as IPointCollection;

                                        //if (PolygonObject2.PointList != null)
                                        //{
                                        //    int m = PolygonObject2.PointList.Count;

                                        //    for (int k = 0; k < m; k++)
                                        //    {
                                        //        curPoint2 = PolygonObject2.PointList[k];
                                        //        curResultPoint2 = new PointClass();
                                        //        curResultPoint2.PutCoords(curPoint2.X, curPoint2.Y);
                                        //        pointSet2.AddPoint(curResultPoint2, ref missing1, ref missing2);
                                        //    }
                                        //}
                                        #endregion

                                        #region 绘制polygon1和polygon2
                                        ...
                                        pMapControl.DrawShape(pPolygon1, ref oSimpleFillSymbol);
                                        pMapControl.DrawShape(pPolygon2, ref oSimpleFillSymbol);
                                        #endregion

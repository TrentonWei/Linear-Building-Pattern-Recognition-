...
namespace AuxStructureLib
{
    public class ProxiEdge
    {
        ...
        public static void Create_WriteEdge2Shp(string filePath, string fileName, List<ProxiEdge> EdgeList, ISpatialReference pSpatialReference)
        {
        ...
        /// <param name="filePath">文件名</param>
        /// <param name="EdgeList">邻近边列表</param>
        public static void Create_WriteNearestDis2Shp(string filePath, string fileName, List<ProxiEdge> EdgeList, ISpatialReference pSpatialReference)
        {
            #region 创建一个线的shape文件
            string Folderpathstr = filePath;
            string LyrName = fileName;

...
namespace AuxStructureLib
{
    ...
    public class SMBR
    {
        ...
        /// 调用ArcGIS实现最小外包矩形
        /// </summary>
        /// <param name="In">输入要素类</param>
        /// <param name="Out">输出要素类</param>
        public static void CreateMBRbyESRI(object In,object Out,string Geometry_Type)
        {
            MinimumBoundingGeometry mbg = new MinimumBoundingGeometry();
            Geoprocessor GP = new Geoprocessor();
            mbg.in_features =In ;            //@"E:\DelaunayShape\湖泊群\map\Road.mdb\lake_cluster";
            mbg.out_feature_class = Out;     //@"E:\DelaunayShape\湖泊群\map\Road.mdb\lake_MBR";
            mbg.geometry_type = Geometry_Type;
            GP.Execute(mbg,null);
        }
        /// <summary>
